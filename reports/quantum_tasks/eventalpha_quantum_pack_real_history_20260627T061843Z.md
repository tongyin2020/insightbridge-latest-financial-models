...
- generated_at: 2026-06-27T06:18:43.743450+00:00
- cases_csv: `/Users/tongyin/Desktop/InsightBridge_Financial_Models_Latest/reports/real_history_validation/eventalpha_real_history_cases_20260627T061843Z.csv`
- matrix_csv: `/Users/tongyin/Desktop/InsightBridge_Financial_Models_Latest/reports/real_history_validation/eventalpha_real_history_matrix_20260627T061843Z.csv`
...
- `rates`: samples=3, avg_pnl_pct=0.114, win_rate=66.7%, avg_wait_seconds=96.1, memory_edge=0.967
- `crypto`: samples=3, avg_pnl_pct=7.229, win_rate=66.7%, avg_wait_seconds=181.1, memory_edge=0.792
- `oil`: samples=22, avg_pnl_pct=0.461, win_rate=63.6%, avg_wait_seconds=272.0, memory_edge=0.563
- `index`: samples=3, avg_pnl_pct=1.362, win_rate=100.0%, avg_wait_seconds=143.3, memory_edge=0.855

## Exact Baseline

- best subset: ['crypto', 'oil', 'index'] | objective=0.297124
- best risk allocation: {"crypto": {"tier": "heavy", "weight": 1.5}, "oil": {"tier": "skip", "weight": 0.0}, "index": {"tier": "normal", "weight": 1.0}} | objective=24.247085
