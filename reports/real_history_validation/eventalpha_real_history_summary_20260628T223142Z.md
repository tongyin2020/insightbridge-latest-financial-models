...
- generated_at: `2026-06-28T22:31:42.384386+00:00`
- event_cases: **374**
...
- subset: **oil, index**
- objective: `0.228`
- mean pnl per case: `0.04%`
- win rate: `4.5%`

## By Asset

- `crypto`: entries=3, win_rate=66.7%, avg_pnl=7.23%, avg_conf=0.886
- `index`: entries=3, win_rate=100.0%, avg_pnl=1.36%, avg_conf=0.912
- `oil`: entries=22, win_rate=63.6%, avg_pnl=0.46%, avg_conf=0.793
...
- `eia_inventory`: entries=18, win_rate=72.2%, avg_pnl=0.59%
